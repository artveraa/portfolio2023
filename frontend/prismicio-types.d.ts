...
type AboutDocumentData = Record<string, never>;
/**
...
interface HomeDocumentData {
  ...
  /**
   * GIF  field in *accueil*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: home.home_gif
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/core-concepts/image
   *
   */
  home_gif: prismicT.ImageField<never>;
  /**
...
interface ProjectDocumentData {
   ...
   *
   */
  category: prismicT.SelectField<
    "Front-end" | "Writing" | "Web design" | "Graphic design"
  >;
  /**
 ...
 *
 */
export type SkillsSliceDefault = prismicT.SharedSliceVariation<
  "default",
 ...
 *
 */
export type ToolsSliceDefault = prismicT.SharedSliceVariation<
  "default",
  Simplify<ToolsSliceDefaultPrimary>,
  Simplify<ToolsSliceDefaultItem>
>;
/**
